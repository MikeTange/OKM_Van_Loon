...
class OKM_processing:
    ...
    def build_gui(self):
        ...
        for key in self.input_files.keys(): # TODO - test with more keys than 4
            ...
            label = tk.Label(self.file_frame, text=f"Select Excel sheet for {key}", anchor="w")
    ...
    @staticmethod
    def load_all_data(input_files : dict, 
    ...
    def load_data(self):
        ...
        handler = AsyncTaskRunner(
            ...
            args=(self.input_files, self.selected_sheets, self.update_status),
